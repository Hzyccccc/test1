<template>
  <div class="addexpenditure" id="addexpenditure">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="date" label="支出项目"></el-table-column>
    ...
    <el-dialog class="oderDialog" title="新增订单信息" :visible.sync="oderDialogVisible">
      <div class="wrap">
        <el-form
          ...
          size="medium"
        >
          <el-form-item label="支出项目：" :title="searchForm.contactName" prop="contactName">
            <el-select v-model="value" filterable placeholder="请选择">
              <el-input></el-input>
            </el-select>
          </el-form-item>
