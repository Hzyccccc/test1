<template>
    <div class="purchaseRK" id="purchaseRK">
      ...
      console.log(item);
        this.$router.push({
            ...
            query: {
              ...
              discountlastmoney:item.discountlastmoney,
     ...
     /*查询用户仓库*/
      ...
      async batchRemove() {
         if (this.tableInfo.length) {
          ...
          if(noApi) {
             this.$message.error('订单中有已审核或者已转采购状态的订单,请重新选择!');
             return;
          }
      ...
      add() {
        this.$router.push({path:'addOrderInfo',query:{page:'rk'}});
      },
      reset() {
        this.pageNum = 1;
        this.pageSize = 10;
